...
import { Play, Calendar, Clock, Tag, Heart, Plus, Eye, ThumbsUp, Film, Star, Download, Tv } from 'lucide-react';
...
// DATOS DE SERIES RELACIONADAS (15 items)
const seriesRelacionadas = Array.from({ length: 15 }, (_, i) => ({
  id: i + 1,
  titulo: [
    'Loki', 'WandaVision', 'Hawkeye', 'Moon Knight', 'Ms. Marvel',
    'She-Hulk', 'Secret Invasion', 'What If...?', 'The Falcon and the Winter Soldier',
    'Agatha All Along', 'Daredevil: Born Again', 'Ironheart', 'Echo',
    'X-Men 97', 'Invincible'
  ][i],
...
const SerieDescripcion = () => {
  ...
  return (
    <div className="relative w-full bg-[#080705] min-h-screen font-sans text-white">
        ...
        <div className="w-full max-w-7xl min-h-[calc(550px-96px)] min-[480px]:min-h-[calc(600px-96px)] min-[801px]:min-h-[calc(800px-96px)] bg-gradient-to-t from-[#080705] via-black/40 to-black/40 rounded-t-2xl flex flex-col p-6 min-[801px]:p-10 gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 flex flex-col min-[1100px]:pr-8">
              ...
              <div className="mt-3">
                <span className="text-[#3b82f6] font-bold text-[10px] bg-[#3b82f6]/10 px-2 py-0.5 rounded border border-[#3b82f6]/20 uppercase tracking-wider">
                  WEB-DL 4K
                </span>
              </div>
              <div className="w-full h-[1px] bg-white/5 mt-5 mb-6"></div>

              {/* METADATOS Y VOTACIÓN */}
              <div className="flex flex-wrap items-center gap-6 mb-6">
                <div className="flex items-center gap-6 text-sm text-gray-300 font-medium">
                  ...
                  <div className="flex items-center gap-2"><Tv size={16} className="text-[#3b82f6]" /> 2h 28m</div>
                  <div className="flex items-center gap-2">
              ...
              <div className="mb-14">
                ...
                <div
                  className="h-24 min-[801px]:h-28 overflow-y-auto no-scrollbar pr-4"
                  style={{
      ...
      {/* ============================================================ */}
      {/* SECCIÓN DE TABS + SIDEBAR DE SERIES RECIENTES                */}
      {/* ============================================================ */}
      <div className="relative z-10 flex justify-center px-6">
        <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-6 items-start">
          ...
          {/* COLUMNA DERECHA: SERIES RECIENTES (20%) - Solo en tab "online" */}
          <AnimatePresence>
            {tabActivo === 'online' && (
              <motion.div
              ...
              >
                <div className="bg-[#0a0908] rounded-b-2xl lg:rounded-2xl overflow-hidden">
                  ...
                  {/* ENCABEZADO: línea azul izquierda + letras separadas */}
